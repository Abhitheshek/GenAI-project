      ...
      <div className="max-w-7xl mx-auto px-6 py-5">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            {user ? (
              <>
                <span className="text-sm text-blue-600 hidden sm:block">{user.name}</span>
              ...
              <>
                <Link href="/login">
                  <Button size="sm" variant="outline" className="border-blue-200 text-blue-600 hover:border-blue-300 px-4 py-2 text-sm">
                    Sign In
                  </Button>
                </Link>
                <Link href="/register">
