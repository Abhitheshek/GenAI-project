  ...
  return (
    <section className="py-10 bg-white">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <h1 className="text-7xl font-light text-black mb-6 leading-tight tracking-tight">
          The Future of
          <br />
          ...
          {user ? (
            <>
              ...
              <Link href={user.role === 'artisan' ? '/buyer' : '/seller'}>
                <Button size="lg" variant="outline" className="border border-gray-200 text-black hover:border-gray-300 px-10 py-4 text-lg font-medium rounded-lg">
